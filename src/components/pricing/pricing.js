...
export default function Pricing() {
  ...
  useEffect(() => {
    // setLoading(true)
    document.title = metaData.pricingTitle;
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", metaData.pricingDesc); // Update the meta description tag
    }
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute("content", metaData.pricingKeywords); // Update the meta description tag
    }
    setLoading(false);
  }, []);
            ...
            <section className="pricing-section section-b-space">
              <div className="container">
                <div className="title-horizontal">
                  <h2>
                    Get pricing plans for Hardware & Software Installation for
                    Auto Trading Robot.
                  </h2>
                    ...
                    <div className="pricing-box">
                      ...
                      <div className="pricing-content">
                        <div className="clip-path-content">
                          ...
                          <a className="pricing-link" data-cursor="pointer"></a>
                        </div>
                      </div>
                    </div>
                  </div>
